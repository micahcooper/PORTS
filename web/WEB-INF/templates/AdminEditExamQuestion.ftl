<html>
	<head>
		<title>Admin Create Exam Question</title>
	...
	<body onload="getSections();">
		<div class="container">
			...
			<div class="menu"></div>
			<div class="content">
				<form name="createExamQuestion" method="post" action="AdminCreateExamQuestion">
...
<input type="submit" value="Main Menu" onclick=document.createExamQuestion.action="AdminMenu";document.createExamQuestion.submit(); />
						</td></tr>
						<tr><td>&nbsp;</td></tr>
					</table>				
				</form>
