		...
		<div class="container">
			...
			<div class="content">
				<table align="left" border=0 width=200%>
					...
					<form name="editExam" method="post">
						<tr align="center"><td colspan=2><h1>Edit Exam</h1></td></tr>
						...
						<tr>
							<td colspan=2><input type="submit" value="Save" onclick=document.editExam.action=FacultyEditExam;> <input type="reset" value="Clear"></td>
						</tr>
						<tr><td colspan=2>&nbsp;<p></td></tr>
