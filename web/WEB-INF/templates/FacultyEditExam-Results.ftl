<html>
	...
	<body>
		<form name="editExam" method="post" action="FacultyCreateExamQuestion">
			<h2>Success!!</h2><br>  
			<tr>
				<td>Thank you <b>${faculty_name}</b>, your exam was successfully edited. Please see details below. <p></td>
			</tr>
			<tr><td><hr></td></tr>
			<tr><td>&nbsp;<p></td></tr>
			...
			<input type="submit" value="Main Menu" onclick=document.editExam.action=FacultyMenu;document.createExamQuestion.submit(); /><p>
