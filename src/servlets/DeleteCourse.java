	...
	extends HttpServlet
{
	...
	*/
	...
	{  	
		...
		String resultTemplateName = "DeleteCourse.ftl";
	...
	*/
		...
		throws ServletException, IOException
	{
		...
		removed = CtrlMaintainCourse.deleteCourse( course_id );

		if( removed )
			message = "Course with ID: "+course_id+" successfully deleted";
		else
			message = "Course could not be found, please check the ID.";
