...
public class FacultyCreateExamQuestion extends HttpServlet{
	...
	public void doPost( HttpServletRequest  req, HttpServletResponse res ) throws ServletException, IOException {
		...
		String resultTemplateName = "FacultyCreateExamQuestion.ftl";	
		String error = "";
		...
		try{
			...
			if(
				...
				resultTemplateName = "FacultyCreateExamQuestion-Results.ftl";
			}else{
